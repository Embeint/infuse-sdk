...
/* Instantiate logger instance used by Zephyr integration code
 * but not created as we don't use littlefs_fs.c
 */
LOG_MODULE_REGISTER(littlefs, CONFIG_INFUSE_LITTLEFS_LOG_LEVEL);
