...
enum lsm6dsv_ctrl3 {
	LSM6DSV_CTRL3_SW_RESET = BIT(0),
	LSM6DSV_CTRL3_IF_INC = BIT(2),
	LSM6DSV_CTRL3_BDU = BIT(6),
	LSM6DSV_CTRL3_REBOOT_MEMORY = BIT(7),
};
...
enum lsm6dsv_ctrl10 {
	LSM6DSV_CTRL10_SELF_TEST_XL_DIS = (0 << 0),
	LSM6DSV_CTRL10_SELF_TEST_XL_POS = (1 << 0),
	LSM6DSV_CTRL10_SELF_TEST_XL_NEG = (2 << 0),
	LSM6DSV_CTRL10_SELF_TEST_G_DIS = (0 << 2),
	LSM6DSV_CTRL10_SELF_TEST_G_POS = (1 << 2),
	LSM6DSV_CTRL10_SELF_TEST_G_NEG = (2 << 2),
	LSM6DSV_CTRL10_EMB_FUNC_DEBUG = BIT(6),
};

enum lsm6dsv_status_reg {
	LSM6DSV_STATUS_REG_XL_DRDY = BIT(0),
	LSM6DSV_STATUS_REG_G_DRDY = BIT(1),
	LSM6DSV_STATUS_REG_TEMP_DRDY = BIT(2),
	LSM6DSV_STATUS_REG_TIMESTAMP_OVERFLOW = BIT(7),
};
...
#define LSM6DSV_XL_SELF_TEST_MIN_MG 50
#define LSM6DSV_XL_SELF_TEST_MAX_MG 1700
#define LSM6DSV_G_SELF_TEST_MIN_DPS 150
#define LSM6DSV_G_SELF_TEST_MAX_DPS 700
