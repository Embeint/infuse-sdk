...
enum {
	...
	BMI270_REG_GYR_GAIN_STATUS = 0x38,
...
/* BMI270_REG_GYR_SELF_TEST_AXES */
#define BMI270_GYR_SELF_TEST_AXES_DONE   BIT(0)
#define BMI270_GYR_SELF_TEST_AXES_X_OK   BIT(1)
#define BMI270_GYR_SELF_TEST_AXES_Y_OK   BIT(2)
#define BMI270_GYR_SELF_TEST_AXES_Z_OK   BIT(3)
#define BMI270_GYR_SELF_TEST_AXES_ALL_OK GENMASK(3, 1)

/* BMI270_REG_ACC_SELF_TEST */
#define BMI270_ACC_SELF_TEST_EN             BIT(0)
#define BMI270_ACC_SELF_TEST_DIS            0
#define BMI270_ACC_SELF_TEST_POSITIVE       BIT(2)
#define BMI270_ACC_SELF_TEST_NEGATIVE       0
#define BMI270_ACC_SELF_TEST_HIGH_AMPLITUDE BIT(3)
#define BMI270_ACC_SELF_TEST_LOW_AMPLITUDE  0
...
/* BMI270_REG_GYR_GAIN_STATUS */
#define BMI270_GYR_GAIN_STATUS_TRIG_STATUS GENMASK(5, 3)
...
/* BMI270 datasheet section 4.12.1 */
#define BMI270_SELF_TEST_ACC_MINIMUM_X 16000
#define BMI270_SELF_TEST_ACC_MAXIMUM_Y -15000
#define BMI270_SELF_TEST_ACC_MINIMUM_Z 10000
