...
#define INPUT_UNIQUE_SCALES_NUM ARRAY_SIZE(INPUT_FEATURES_SCALE_MIN)
...
static const nrf_edgeai_features_pipeline_ctx_t timedomain_pipeline_ = {
	.functions_num = ARRAY_SIZE(timedomain_features_),
...
static const nrf_edgeai_features_pipeline_ctx_t freqdomain_pipeline_ = {
	.functions_num = ARRAY_SIZE(freqdomain_features_),
