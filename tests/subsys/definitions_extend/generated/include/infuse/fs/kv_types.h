...
enum kv_builtin_id {
	...
	/** Extension KV slot 2 */
	KV_KEY_EXT2 = 32770,
#ifdef CONFIG_KV_STORE_KEY_EXT2_RANGE
	/** End of currently enabled KV_KEY_EXT2 range */
	KV_KEY_EXT2_END = 32770 + CONFIG_KV_STORE_KEY_EXT2_RANGE - 1,
#endif
	/** Maximum number of KV_KEY_EXT2 slots that can be enabled */
	KV_KEY_EXT2_MAX = 32771,
	/** Extension KV slot 3 */
	KV_KEY_EXT3 = 32772,
...
enum kv_builtin_size {
	...
	_KV_KEY_EXT3_SIZE = sizeof(struct kv_ext3),
};
...
#define _KV_KEY_EXT1_TYPE struct kv_ext1
#define _KV_KEY_EXT2_TYPE struct kv_ext2
#define _KV_KEY_EXT3_TYPE struct kv_ext3
/* clang-format on */
...
#define KV_REFLECT_NUM ( \
	...
	IF_ENABLED(CONFIG_KV_STORE_KEY_EXT1, \
		   (1 +)) \
	0)
/* clang-format on */
...
#ifdef CONFIG_KV_STORE_KEY_EXT1
	{
		.key = KV_KEY_EXT1,
		.range = 1,
		.flags = KV_FLAGS_REFLECT,
	},
#endif /* CONFIG_KV_STORE_KEY_EXT1 */
#ifdef CONFIG_KV_STORE_KEY_EXT2
	{
		.key = KV_KEY_EXT2,
		.range = CONFIG_KV_STORE_KEY_EXT2_RANGE,
		.flags = KV_FLAGS_READ_ONLY,
	},
#endif /* CONFIG_KV_STORE_KEY_EXT2 */
#ifdef CONFIG_KV_STORE_KEY_EXT3
	{
		.key = KV_KEY_EXT3,
		.range = 1,
		.flags = 0,
	},
#endif /* CONFIG_KV_STORE_KEY_EXT3 */
};
