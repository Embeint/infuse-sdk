...
ZTEST(rpc_watchdog, test_watchdog)
{
	extern const k_tid_t rpc_server_thread;
	int rc;
	...
	k_thread_suspend(rpc_server_thread);
...
ZTEST_SUITE(rpc_watchdog, NULL, NULL, NULL, NULL, watchdog_teardown);
