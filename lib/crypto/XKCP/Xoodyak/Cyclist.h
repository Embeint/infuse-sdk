...
#define KCP_DeclareCyclistFunctions(prefix)                                                        \
	void prefix##_Initialize(prefix##_Instance *instance, const uint8_t *K, size_t KLen,       \
				 const uint8_t *ID, size_t IDLen, const uint8_t *counter,          \
				 size_t counterLen);                                               \
	void prefix##_Absorb(prefix##_Instance *instance, const uint8_t *X, size_t XLen);          \
	void prefix##_Encrypt(prefix##_Instance *instance, const uint8_t *P, uint8_t *C,           \
			      size_t PLen);                                                        \
	void prefix##_Decrypt(prefix##_Instance *instance, const uint8_t *C, uint8_t *P,           \
			      size_t CLen);                                                        \
