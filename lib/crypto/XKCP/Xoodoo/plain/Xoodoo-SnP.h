...
void Xoodoo_AddBytes(Xoodoo_plain32_state *state, const uint8_t *data, unsigned int offset,
		     unsigned int length);
void Xoodoo_OverwriteBytes(Xoodoo_plain32_state *state, const uint8_t *data, unsigned int offset,
			   unsigned int length);
...
void Xoodoo_ExtractBytes(const Xoodoo_plain32_state *state, uint8_t *data, unsigned int offset,
			 unsigned int length);
void Xoodoo_ExtractAndAddBytes(const Xoodoo_plain32_state *state, const uint8_t *input,
...
// size_t Xoofff_ExpandFastLoop(uint8_t *yAccu, const uint8_t *kRoll, uint8_t *output, size_t
// length);
...
size_t Xoodyak_EncryptFullBlocks(Xoodoo_plain32_state *state, const uint8_t *I, uint8_t *O,
				 size_t IOLen);
size_t Xoodyak_DecryptFullBlocks(Xoodoo_plain32_state *state, const uint8_t *I, uint8_t *O,
				 size_t IOLen);
