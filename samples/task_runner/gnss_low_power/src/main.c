...
static const struct task_schedule schedules[] = {
	/* Runs for 3 minutes, restarted quickly after termination.
	 * If GNSS signals are not available, retries every minute.
	 * Intentded to exercise the modem transitions, not be a realistic schedule.
	 */
	{
