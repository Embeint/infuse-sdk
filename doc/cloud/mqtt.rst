...
The purpose of the Infuse-IoT `MQTT data stream`_ is to provide the real-time
...
.. _MQTT data stream: https://docs.infuse-cloud.io/docs/infuse-iot-cloud/connectivity
